...
export const DUMMY_POSTS: Post[] = [
  {
    ...
    title: "সাংগঠনিক শক্তি বৃদ্ধিতে সকল নেতা-কর্মীর প্রতি আহ্বান",
    content: "📌 সাংগঠনিক বার্তা:\n\nদল ও দেশের স্বার্থে সকল স্তরের নেতা-কর্মীদের ঐক্যবদ্ধ থাকার আহ্বান জানানো হচ্ছে।\n\nনির্দেশনাবলী:\n১. মনোবল দৃঢ় রাখুন\n২. সংগঠনকে আরও শক্তিশালী করুন\n৩. ঐক্যবদ্ধ থাকুন\n৪. দলের জন্য সবসময় প্রস্তুত থাকুন\n\nএকটাই লক্ষ্য — সংগঠনকে আরও শক্তিশালী করা।",
    ...
    sharesCount: 2950,
    commentsList: [
      { id: "c1", author: "Md Hasan Mahmud", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&auto=format&fit=crop&q=80", time: "৮ মিনিট আগে", text: "জয় বাংলা! ঢাকা বিভাগ সম্পূর্ণ প্রস্তুত।" },
      { id: "c2", author: "Sultana Razia", avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&auto=format&fit=crop&q=80", time: "৫ মিনিট আগে", text: "ইনশাআল্লাহ আমরা ঐক্যবদ্ধ থাকব।" }
    ]
  },
  {
    id: "post-102",
